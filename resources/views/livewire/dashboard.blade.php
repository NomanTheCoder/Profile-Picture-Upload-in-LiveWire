        ...
        <div id="todos-list">
            ...
            <div wire:key="{{$todo->id}}" class="todo mb-5 card px-5 py-6 bg-white col-span-1 border-t-2 border-blue-500 hover:shadow">
                <div class="flex justify-between space-x-2">
                    ...
                    <input type="text" wire:model="editTodoName" placeholder="Todo.." class="bg-gray-100 text-gray-900 text-sm rounded block w-full p-2.5">
                    @error('editTodoName')
                ...
                <div class="mt-3 text-xs text-gray-700">
                    @if($editTodoID == $todo->id)
                        <button wire:click="update" class="mt-3 px-4 py-2 bg-green-500 text-white font-semibold rounded hover:bg-green-600">Update</button> 
